		...
		"attachments": [
			{
		        ...
		        "author_icon": icon,
		        "title": `${req.body.action.memberCreator.fullName} adicionou ${req.body.action.member.fullName} ao quadro`,
...
**Membro Adicionado**: ${req.body.action.member.fullName} (${req.body.action.member.username})`
		    	}
		    ]
	})
	.end((err2, res3)=>{
