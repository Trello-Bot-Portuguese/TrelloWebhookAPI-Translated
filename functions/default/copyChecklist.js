		...
		"attachments": [
			{
		        ...
		        "author_icon": icon,
		        "title": `${req.body.action.memberCreator.fullName} copiou os itens da lista \"${req.body.action.data.checklistSource.name}\" para a lista \"${req.body.action.data.checklist.name}\" no cartão \"${req.body.action.data.card.name}\"`,
