		...
		"attachments": [
			{
		        ...
		        "author_icon": icon,
		        "title": `${req.body.action.memberCreator.fullName} deletou o item \"${req.body.action.data.checkItem.name}\" na lista \"${req.body.action.data.checklist.name}\" do cartão \"${req.body.action.data.card.name}\"`,
