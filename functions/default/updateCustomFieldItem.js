  ...
  switch(req.body.action.data.customField.type){
    case "checkbox":
      jso = {
        ...
        "author_icon": icon,
        "title": `${req.body.action.memberCreator.fullName} ${removed ? "des" : ""}marcou o campo costumizado \"${req.body.action.data.customField.name}\" no cartão \"${req.body.action.data.card.name}\"`,
...
**Cartão**: [${req.body.action.data.card.name}](https://trello.com/c/${req.body.action.data.card.shortLink})`
    ...
    case "text":
      jso = {
        ...
        "author_name": "Trello: "+req.body.model.name,
        "author_icon": icon,
        "title": `${req.body.action.memberCreator.fullName} ${removed ? "removeu" : "alterou"} o campo \"${req.body.action.data.customField.name}\" no cartão \"${req.body.action.data.card.name}\"`,
        "title_link": `https://trello.com/b/${req.body.action.data.board.shortLink}`,
        "thumb_url": req.body.action.memberCreator.avatarHash ? "https://trello-avatars.s3.amazonaws.com/"+req.body.action.memberCreator.avatarHash+"/170.png" : undefined,
        "text": `**Membro**: ${req.body.action.memberCreator.fullName} (${req.body.action.memberCreator.username})
**Cartão**: [${req.body.action.data.card.name}](https://trello.com/c/${req.body.action.data.card.shortLink})
${!added ? `**Valor Anterior**: ${req.body.action.data.old.value.text}\n`: ""}${!removed ? `**Novo Valor**: ${req.body.action.data.customFieldItem.value.text}`: ""}`
      }
      break;
    case "number":
      jso = {
        ...
        "text": `**Membro**: ${req.body.action.memberCreator.fullName} (${req.body.action.memberCreator.username})
**Cartão**: [${req.body.action.data.card.name}](https://trello.com/c/${req.body.action.data.card.shortLink})
${!added ? `**Valor Anterior**: ${req.body.action.data.old.value.number}\n`: ""}${!removed ? `**Novo Valor**: ${req.body.action.data.customFieldItem.value.number}`: ""}`
      }
      break;
    case "date":
      jso = {
